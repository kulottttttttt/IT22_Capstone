# PowerShell Script Part 3: Generate Controllers for Zones and ParkingSlots

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Generating Controllers" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$presPath = "src\SmartParking.Presentation\Controllers"

# ZonesController
Write-Host "Creating ZonesController..." -ForegroundColor Yellow
...
'@
Set-Content -Path "$presPath\ZonesController.cs" -Value $content
Write-Host "✓ ZonesController created" -ForegroundColor Green

# ParkingSlotsController
Write-Host "Creating ParkingSlotsController..." -ForegroundColor Yellow
...
'@
Set-Content -Path "$presPath\ParkingSlotsController.cs" -Value $content
Write-Host "✓ ParkingSlotsController created" -ForegroundColor Green

Write-Host ""
Write-Host "========================================" -ForegroundColor Green
Write-Host "All Controllers created successfully!" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "Phase 3 file generation complete!" -ForegroundColor Cyan
Write-Host "Run 'dotnet build' to compile the project." -ForegroundColor Cyan
